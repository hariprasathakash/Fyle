...
@Component({
  ...
  <nav style="background: rgb(37, 33, 41); background: linear-gradient(90deg, rgba(37, 33, 41, 1) 57%, rgba(25, 52, 93, 1) 98%);" class="p-4">
    <div class="container mx-auto flex justify-between items-center">
      ...
      <div class="hidden font-extrabold text-3xl antialiased font-serif tracking-wide mr-[700px]  lg:flex items-center text-center text-white mx-auto  ">
        <h1>Github</h1>
    </div>
      <div class="relative">
  ...
  <h1 class=" mt-40 text-4xl font-bold mb-8">GitHub Search</h1>
  
  <div class="mb-4">
    <label for="username" class="block text-sm font-large text-gray-600 font-bold mb-2">GitHub Username:</label>
    <div class="flex">
      <input type="text" id="username" [(ngModel)]="username" class="p-3 border rounded-md focus:outline-none focus:border-indigo-700" />
      <button (click)="$event.preventDefault();searchRepositories()" class="ml-4 px-4 py-2 bg-black text-white rounded-md focus:outline-none hover:bg-violet-700">Search Repositories</button>
    </div>
  </div>
</div>
